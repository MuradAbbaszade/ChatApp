...
<html>
    ...
    <head>
        ...
        <style>
            <%@ include file="assets/privatechat.css"%>
        </style>
                ...
                xhttp.onload = function () {
                    ...
                    for (var i = j; i < list.length; i++) {
                        ...
                        if (message.name == "${name}")
                            ...
                            printMessageInLeft(message);
                    }
                    j = list.length;
                }
                xhttp.open("GET", "http://localhost:8081/ChatAppWeb/privateMessages/${friendId}");
                xhttp.send();
            }
    ...
    <body onload="loadDoc()" >
        ...
        <div id="container">
            ...
            <form class="form-outline container" action="/ChatAppWeb/privateMessages/${friendId}" method="POST">
                ...
                <br>
                <a class="btn btn-danger" href="/ChatAppWeb/main">Back</a>
